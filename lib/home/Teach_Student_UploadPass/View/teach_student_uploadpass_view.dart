...
import 'package:flutter_app01/home/Teach_Student_UploadPass/ViewModel/teach_student_uploadpass_viewmodel.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:provide/provide.dart';

class teach_student_uploadpass_view extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return teach_student_uploadpass_view_State();
  }
}

class teach_student_uploadpass_view_State
    extends State<teach_student_uploadpass_view> {
  var providers = Providers();

  void _loading() {
    var tsum = teach_student_uploadpass_model();
    var tsuv = teach_student_uploadpass_viewmodel(tsum, context);
    providers.provide(Provider<teach_student_uploadpass_viewmodel>.value(tsuv));
  }
  ...
  Widget oldpssword_input() {
    return new Container(
      ...
      child: Provide<teach_student_uploadpass_viewmodel>(
