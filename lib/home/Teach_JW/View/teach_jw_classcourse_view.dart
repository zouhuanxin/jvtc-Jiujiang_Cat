...
import 'package:flutter_app01/home/Teach_JW/ViewModel/teach_jw_classcourse_viewmodel.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:provide/provide.dart';

class teach_jw_classcourse_view extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return teach_jw_classcourse_view_State();
  }

}

class teach_jw_classcourse_view_State extends State<teach_jw_classcourse_view>{
  Teach_JW_Util tju=Teach_JW_Util();

  var providers = Providers();
  void _loading() {
    var tjcm = teach_jw_classcourse_model();
    var tjcv = teach_jw_classcourse_viewmodel(tjcm,context);
    providers.provide(Provider<teach_jw_classcourse_viewmodel>.value(tjcv));
  }
  @override
  void initState() {
  ...
  Widget drop1() {
    return new Align(
      ...
      child: Provide<teach_jw_classcourse_viewmodel>(builder:(context,child,value){
  ...
  Widget drop6() {
    return new Align(
      ...
      child: Provide<teach_jw_classcourse_viewmodel>(builder:(context,child,value){
        return DropdownButton(
          items: value.getListData3(),
          hint: new Text('校区', textAlign: TextAlign.center),
          //当没有默认值的时候可以设置的提示
          value: value.xqid,
          //下拉菜单选择完之后显示给用户的值
          onChanged: (T) {
            value.set_drop_data('xqid',T);
          },
          elevation: 20,
          underline: Container(),
          //设置阴影的高度
  ...
  Widget drop7() {
    return new Align(
      ...
      child: Provide<teach_jw_classcourse_viewmodel>(builder:(context,child,value){
        return DropdownButton(
          items: value.getListData4(),
          hint: new Text('楼', textAlign: TextAlign.center),
          //当没有默认值的时候可以设置的提示
          value: value.jzwid,
          //下拉菜单选择完之后显示给用户的值
          onChanged: (T) {
            value.set_drop_data('jzwid',T);
          },
          elevation: 20,
          underline: Container(),
          //设置阴影的高度
  ...
  Widget buildSearchButton() {
    return Align(
      child: SizedBox(
        ...
        width: 270.0,
        child:
        Provide<teach_jw_classcourse_viewmodel>(builder: (context, child, value) {
          return RaisedButton(
            child: Text(
              '查询',
...
//              ),
              ...
              Row(
                children: <Widget>[
                  Expanded(child: drop6(),flex: 1,),
                  Expanded(child: drop7(),flex: 1,),
                ],
              ),
              Text(
                '   教室号:',
