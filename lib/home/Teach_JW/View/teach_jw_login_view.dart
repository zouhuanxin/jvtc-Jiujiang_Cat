...
class teach_jw_login_view extends StatefulWidget {
  final teach_jw_login_viewmodel value;

  const teach_jw_login_view({Key key, this.value}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return teach_jw_login_view_State(value);
  }
}

class teach_jw_login_view_State extends State<teach_jw_login_view> {
  var providers = Providers();
  var tjlv;

  teach_jw_login_view_State(teach_jw_login_viewmodel value){
    this.tjlv=value;
  }

  void _loading() {
//    var tjlm = teach_jw_login_model();
//    var tjlv = teach_jw_login_viewmodel(tjlm);
    providers.provide(Provider<teach_jw_login_viewmodel>.value(tjlv));
  }
  ...
  Widget username_input() {
    return new Container(
      child: new Provide<teach_jw_login_viewmodel>(
  ...
  Widget buildLoginButton() {
    return Align(
      child: SizedBox(
        ...
        width: 270.0,
        child:
            Provide<teach_jw_login_viewmodel>(builder: (context, child, value) {
          return RaisedButton(
            child: Text(
              '登陆',
