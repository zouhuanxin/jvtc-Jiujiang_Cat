...
class teach_jw_uploadpass_viewmodel with ChangeNotifier {
  teach_jw_uploadpass_model tjum;
  String oldpassword, password1, password2;
  bool vis1=true,vis2=true,vis3=true;
  SharedPreferences prefs;
  BuildContext context;

  teach_jw_uploadpass_viewmodel(teach_jw_uploadpass_model tjum,BuildContext context){
    this.tjum=tjum;
  ...
  void uploadpss() async{
    ...
    String res1=await this.tjum.jw_uploadpss(prefs, oldpassword, password1, password2);
    if(res1!=null){
