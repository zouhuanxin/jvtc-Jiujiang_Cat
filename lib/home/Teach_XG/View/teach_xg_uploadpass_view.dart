...
import 'package:flutter_app01/home/Teach_XG/ViewModel/teach_xg_uploadpass_viewmodel.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:provide/provide.dart';

class teach_xg_uploadpass_view extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return teach_xg_uploadpass_view_State();
  }
}

class teach_xg_uploadpass_view_State extends State<teach_xg_uploadpass_view> {
  var providers = Providers();

  void _loading() {
    var txum = teach_xg_uploadpass_model();
    var txuv = teach_xg_uploadpass_viewmodel(txum, context);
    providers.provide(Provider<teach_xg_uploadpass_viewmodel>.value(txuv));
  }
  ...
  Widget oldpssword_input() {
    return new Container(
      ...
      child: Provide<teach_xg_uploadpass_viewmodel>(
