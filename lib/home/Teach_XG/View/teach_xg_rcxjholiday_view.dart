...
class teach_xg_rcxjholiday_view extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return teach_xg_rcxjholiday_view_State();
  }

}

class teach_xg_rcxjholiday_view_State extends State<teach_xg_rcxjholiday_view>{
  var providers = Providers();

  void _loading() async{
    var txrm= teach_xg_rcxjholiday_model();
    var txrv= teach_xg_rcxjholiday_viewmodel(txrm);
    providers.provide(Provider<teach_xg_rcxjholiday_viewmodel>.value(txrv));
  }
  ...
  Widget drop1() {
    return new Align(
      ...
      child: Provide<teach_xg_rcxjholiday_viewmodel>(builder:(context,child,value){
  ...
  Widget search_button(){
    return new Container(
      ...
      child: Provide<teach_xg_rcxjholiday_viewmodel>(builder: (context,child,value){return new RaisedButton(onPressed: (){
        value.search_data();
