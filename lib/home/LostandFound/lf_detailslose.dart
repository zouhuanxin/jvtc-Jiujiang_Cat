...
class lf_detailslose extends StatefulWidget {
  final String id;

  const lf_detailslose({Key key, this.id}) : super(key: key);

  @override
  State<StatefulWidget> createState() => lf_detailslose_State(id);
}

class lf_detailslose_State extends State<lf_detailslose> {
  String id = '';
  ...
  lf_detailslose_State(str) {
    id = str;
  }

  void getall(str) async {
    String str1 = await Lose_HttpUtil.get_losea3(
        'losea_router/getlosea3', str, (currentPage - 1) * linesize, 2);
    ...
    setState(() {
      ...
      type = json.decode(json.encode(alllosebdata[0]))['reward_money'];
